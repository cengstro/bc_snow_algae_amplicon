...
species_colors <- c("Chlainomonas A"="#ac71b5","Chlainomonas rubra"="#ac71b5", #purple
                ...
                # greyish light green
                "Trebouxiophyceae G"="#6a2d2f", "Trebouxiophyceae"="#6a2d2f", # maroon, standout
...
ggsave(here::here("manuscript/figs/stack.pdf"), plot=stack_no_legend, width=7, height=5)
ggsave(here::here("manuscript/figs/stack_legend.pdf"), plot=legend, width=7, height=5)
