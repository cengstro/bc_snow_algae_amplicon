...
ggsave(filename = here("presentation/omics/asvs.pdf"), plot=present_version, width = 7, height = 3.5)
ggsave(filename = here("presentation/omics/asv_legend.pdf"), plot=legend,  height = 4, width = 2.2)
