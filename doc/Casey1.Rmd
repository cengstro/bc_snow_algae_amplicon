...
Snow algae are cold-adapted microalgae that bloom in melting snow [@Leya2013]. Red pigments produced by some species of snow algae can color vast areas of polar and alpine snowfields, which decreases snow surface albedo, by one estimate enough to substantially increase the rate of snow melt [@Ganey2017]. Loss of snow cover can contribute to drought [@Staudinger2014;@Barnhart2016] and exposes darker surfaces upon meltout, contributing to snow-albedo feedback [@Dery2007]. Thus, snow algae could play an important role in the cryosphere, yet little is known about what species of algae are present, or differences in community composition between snow algae blooms. 

Until recently, snow algae species were defined and identified on the basis of morphology. Morphology can be deceptive when identifying microalgae, as the same species can look completely different from one life stage to the next [@Shah2016;@Salome2019]. In the lab, cultures of *Chloromonas* are all morphologically indistinct green biflagellates, but field samples of this genus are dominated by cells with yellow or orange pigment and have thick cell walls with flanges or spikes [@Matsuzaki2019;@Prochazkova2019a]. Cells formerly defined by morphological similarity can be genetically distinct, for example cell types referred to as *Chloromonas cf. nivalis* are now split into multiple species [@Matsuzaki2019;@Prochazhova2019a].
...
To date, genetic studies have identified three genera of algae that cause most snow algae blooms: *Chloromonas*, *Sanguina*, and *Chlainomonas*. Only *Chloromonas* contains cultured representatives, with _ named species on GenBank. *Chloromonas* are not known to produce the red pigment. *Sanguina* was recently designated, and contains just two species, one of which *Sanguina nivaloides* is found in alpine and polar snowfields worldwide, and is likely synonymous with some of *Chlamydomonas cf. nivalis* [@Prochazkova2018c]. *Chlainomonas* are less studied, but appear in field samples as large (up to 40 $\mu$m diameter) quadriflagellate oval red cells. In spite of their striking morphological differences, *rbc*L and 18S phylogeny places them within the *Chloromonas* clade.
...
The habitat distribution of snow algae are not well established. Amplicon high-throughput sequencing (HTS) shows that red snow from sites across the Arctic are dominated by reads with high similarity to *Sanguina*, with low relative abundance of *Chloromonas polyptera*, *Chloromonas cf. nivalis*, and *Raphidonema* [@Lutz2016a]. @Ganey2018 suggests that the red pigment of snow algae may be a special adaptation to drier snow, while green snow is restricted to moister areas, although red snow caused by *Chlainomonas* is only reported from waterlogged snow overlying alpine lakes [@Novis2008;@Prochazkova2018c]. Green snow blooms dominated by *Chloromonas* are reported from forested sites and shaded snowbanks [@Terashima2017;@Remias2013a], although some *Chloromonas* may be specially adapted for high light intensity in the alpine [@Prochazkova2019a]. In the Arctic, one green snow patch was dominated by *Microglena* [@Lutz2015]. Microscopy suggests differences in the snow algae community above and below treeline: two studies found red snow containing *Sanguina*-like cells to be prevalent in the alpine zone above treeline, while green and orange snows caused by *Chloromonas cf. brevispina* and *Chloromonas cf. nivalis* were prevalent in the subalpine zone below treeline [@Hoham1979a;@Nedbalova2008a]. 

<!-- clear objectives section -->
 Whether snow algae blooms are typically dominated by a single species, or contain a diversity of species remains an open question, as high-resolution genetic comparison between communities is lacking.
 
Thus far, efforts to characterize snow algae communities by amplicon high-throughput sequencing (HTS) have been limited by ambiguous or nonexistent reference sequences and high 18S similarity between snow algae species [@Lutz2018]. To robustly compare snow algae community comparison side-by-side we used rbcL and 18S amplicon HTS and microscopy to survey 35 snow algae communities in our local mountains, to see what species were present, to compare community composition between samples, and see how they are distributed across the landscape. 
