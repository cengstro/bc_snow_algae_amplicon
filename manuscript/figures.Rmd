...
library(tidyverse)
library(here)
opts_chunk$set(fig.width=12, fig.height=8, fig.path='figs/', fig.align= "center", echo=FALSE, warning=FALSE, message=FALSE)
```



```{r input, include=F}
field <- include_graphics(here("manuscript/figs/1_field/field.png"))
asvs <- include_graphics(here("manuscript/figs/2_taxonomy/combined.png"))
...
field_cap <- "Representative photos and microphotos of snow algae. A. Red snow bloom above treeline, sample G1.1. B. Green snow hidden below surface, same sample site as S9. C. Bronze snow spots below trees. D. Red snow containing *Sanguina nivaloides* and *Chlainomonas rubra* morphologies. All scale bars 30 um. E. Orange-green snow containing *Chloromonas krienitzii* and *Chloromonas cf. nivalis*. F. Snow algae from green snow, including *Chloromonas cf. brevispina* and *Chlainomonas rubra*. G. Heatmap of cell count data, with samples on the y axis arranged from low to high elevation, and cell type on the x axis."
