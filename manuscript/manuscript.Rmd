...
**Figure 2.** Ordination plots of *rbcL* amplicon sequence variant (ASV) similarity. A. Multidimensional scaling (MDS) plot. Taxonomy (assigned by IDTaxa) indicated by color, and size of point is proportional to cumulative relative abundance. Dotted ellipses show OTU clusters. Stress = 0.13. B. t-Distributed Stochastic Neighbor Embedding (t-SNE) dimensionality reduction plot of snow algae *rbcL* ASVs. Perplexity = 30.l
