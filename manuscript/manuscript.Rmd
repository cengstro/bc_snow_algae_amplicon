---
title: "Snow algae in the alpine and subalpine zones of British Columbia"
...
abstract: |
  Snow algae grow in melting summer snowfields throughout polar and alpine regions, forming extensive blooms that reduce albedo and increase snow melt. Green, orange, and red patches of snow algae can harbor morphologically diverse algae, but despite their global ubiquity the algal species composition of blooms is largely unknown. We Illumina sequenced 18S and *rbcL* amplicons from 33 snow algae samples collected from a range of alpine and subalpine habitats in the Coast Range of British Columbia, Canada. Predominant species were in, or closely related to, the genera *Sanguina*, *Chloromonas*, and *Chlainomonas*. The most common genus above treeline were *Sanguina*, while *Chloromonas* were dominant below treeline, and *Chlainomonas* were abundant in samples across all elevations. We found species composition was highly variable from patch to patch, even on the same mountain. Although snow algae in the Coast Range are represented by the same relatively few genera that dominate most reports of snow algal blooms around the globe, we found high diversity at the species level. 
---
...
# Introduction {-}
<!-- audience, problem -->
Each summer in polar and alpine snowfields worldwide, vast areas of snow surface are colored red by snow algae blooms. These extremophilic single-celled algae photosynthesize in near-freezing temperatures under high solar irradiance, and are the primary producers in a poorly-understood microbiome that includes bacteria, fungi, ciliates, and rotifers[@gorton_ultraviolet_2003;@lutz_biogeography_2016]. Snow algae blooms occur on every continent and Arctic sea ice[@segawa_bipolar_2018;@duval_snow_1999;@marchant_snow_1982;@yoshimura_community_1997;@vimercati_nieves_2019;@gradinger_snow_1996]; in Alaska, snow algae spectral signatures were detected in one third of a 2,000 km^2^ icefield[@ganey_role_2017]. In recent years snow algae have recieved attention for their impact on snow surface albedo: initial estimates suggests snow algae could increase snow melt rate by as much as 17%, potentially regulating spring snow melt and impacting global albedo[@ganey_role_2017]. Despite their global ubiquity, we are only beginning to identify the algae that are the primary producers in these complex microbiomes.

<!-- Reduction in cryospheric albedo has become the focus of attention in recent years as an important feedback loop of global warming. Microbial growth on snow surface can reduce albedo, notably when snow algae form extensive blooms on melting summer snow[@ganey_role_2017;@lutz_biogeography_2016;@onuma_temporal_2019]. . Despite their global ubiquity, the  we are only beginning to identify the various types of algae communities that cause snow algae blooms.  -->
...
<!-- need to introduce the idea of patchiness, and idea of different colored snow -->
Snow algae blooms can contain a mix of species, many of whose taxonomic identity is not well established. Green algae (Chlorophyceae) are often prevalent: *Sanguina nivaloides* is found in red snow samples worldwide[@prochazkova_sanguina_2019]. Currently just two species are described for *Sanguina*---the other, *S. aurantia* is known from three orange snow samples from Svalbard.


Snow algae form colored patches in otherwise white snowfields, growing in suncups

Different patches of colored snow can contain different algae communities

. Currently just two species are described for *Sanguina*, many genetic sequences retrieved from red snow have not been taxonomically assigned[@prochazkova_sanguina_2019]. Other Chlorophyceae include *Chloromonas* (fourteen species identified to date) and the closely-related but morphologically distinct *Chlainomonas* (two species)[@matsuzaki_taxonomic_2019;@novis_two_2008]. All species of *Chloromonas* have been cultivated in the lab, but *Sanguina* and *Chlainomonas* remain uncultured@matsuzaki_taxonomic_2019].

The distribution of snow algae species are not understood, 

although two studies found snow algae blooms dominated by class Chrysophyceae[@soto_microbial_2020;@remias_two_2019], and one study found a green snow algae bloom dominated by Trebouxiophyceae in Greenland[@lutz_integrated_2015].
