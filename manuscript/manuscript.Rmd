...
<!-- re work this to follow the flow of my presentation -->
...
Snow algae are the primary producer in a little-studied microbiome that includes protists, fungi, bacteria, and viruses[@naff_phylogeny_2013;@lutz_biogeography_2016;@hamilton_primary_2017;@terashima_microbial_2017;@hisakawa_metagenomic_2015]. Despite nearly a century of microscopic study of red snow[@leya_snow_2013], how snow algae blooms develop remains a mystery. How do cells propagate in this harsh environment? What limits the extent of snow algae blooms? Critically, we lack basic understanding of snow algae diversity and life history.
