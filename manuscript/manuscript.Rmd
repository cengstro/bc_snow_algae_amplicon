---
title: "Contrasting alpine and subalpine snow algae communities in British Columbia, Canada"
...
abstract: |
  Snow algae grow in melting summer snowfields throughout polar and alpine regions, forming extensive blooms that reduce albedo and increase snow melt. Green, orange, and red patches of snow algae can harbour morphologically diverse communities, but despite their global ubiquity the community composition of snow algae blooms are poorly understood. We Illumina sequenced 18S and *rbcL* amplicons from 33 snow algae samples collected from a range of alpine and subalpine habitats in the Coast Range of British Columbia, Canada. Communities were dominated by algae closely related to *Sanguina* and *Chloromonas*, the latter including genetically distinct sub-groups including clusters matching *Chlainomonas* and several sub-groups that could represent potentially novel clades. Above treeline snow algae communities were dominated by *Sanguina*, while *Chloromonas krienitzii* was found in snow runnels near treeline, which transitioned from green to orange throughout the season. *Chlainomonas* was abundant in samples across all elevations. Our results suggest that while snow algae diversity at the genus level is relatively low much remains to be explored at the species level, and that communities of snow algae can differ greatly from patch to patch of snow. 
---
