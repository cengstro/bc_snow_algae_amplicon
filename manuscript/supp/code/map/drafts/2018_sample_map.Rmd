...
* loads rda from the saved google map so I dont have to re-load it again and again... this could be tidier
* Specify here::here to avoid conflict with lubridate::here
```{r include=F}
...
ggsave(filename = here::here("manuscript/figs/map.tiff"), plot=full_map)
