...
rbcl_otu_colors <- c("Chlainomonas A"="#ac71b5",
                     "Sanguina B"="#ff534a", 
                      "Chloromonas krienitzii"="#ffa54c","Chloromonas C"="#87b1d4", "Chloromonas D"="#94cf92", "Chloromonas F"="#fdfd96", "Other Chloromonas"="#4aaf53", 
...
otu_tree <- rbcl_ggtree +
  ...
  geom_tippoint(data = annotation, aes(color= otu_name), alpha=1, size=3) + 
...
ggsave(filename=here::here("manuscript/supp/drafts/fig_S3_tree.pdf"), width = 200, height = 425, units="mm", dpi=300)