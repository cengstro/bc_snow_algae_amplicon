...
```{r, include=F}
map <- knitr::include_graphics(here::here("manuscript/figs/map.png")) # crop zoom, city font white, each site gets one point with box specifying elev range, n samples, dates, 
...
cellct <- include_graphics(here("manuscript/figs/supp/cellct_scatterpie/cellct_scatterpie.png")) # make pies circles circular! they're shightly squished lengthwise
tree_otu <- include_graphics(here("manuscript/supp/figs/otu_tree.png"))
...
micro_photo_cap <- "Microphotos of snow algae samples included in sequencing run."
