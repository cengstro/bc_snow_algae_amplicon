...
(ref:cellct_cap) "Heatmap showing cell count relative abundance from 117 snow algae samples. Cb = Chlainomonas cf. brevispina, Ck=Chloromonas krienitzii, Cn=Chloromonas cf. nivalis, Cr=Chlainomonas rubra, G=green cells, O=other, Sn=Sanguina nivaloides"
```
